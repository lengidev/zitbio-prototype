  ...
  function ecosystemInsights(observations, options) {
    ...
    if (recommendations.length === 0 && list.length > 0) {
      recommendations.push({
        ...
        severity: 'healthy',
        action: 'These records describe sightings and ecological roles, not a park population total. Use Ecological State after a complete, approved wildlife census to assess baseline population and carrying pressure.'
      });
    }
