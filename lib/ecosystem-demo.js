...
(function (root, factory) {
  ...
  var SOURCES = {
    FAO_FEED_ASSESSMENT: {
      id: 'fao-feed-assessment', tier: 'C', label: 'Demo calculation method',
  ...
  var FIELDS = [
    {
      ...
      options: [
        ...
        { id: 'full', label: 'Full demo area · 100%', value: 100 }
      ]
    },
    {
    ...
    },
    {
      ...
      note: 'Demo structure used to resolve shelter, browse and grass competition.',
      options: [
    ...
    },
    {
      ...
      note: 'Observed share of the accessible bank showing disturbance in this demo.',
      options: [
    ...
    },
    {
      ...
      options: [
        { id: 'acidic', label: 'Acidic deposition demo · pH 4.2', value: 4.2 },
        { id: 'typical', label: 'Typical rain demo · pH 5.6', value: 5.6 }
      ]
    }
  ];
  ...
  function normalize(input) {
    ...
    FIELDS.forEach(function (field) {
      ...
      if (!option) {
        errors.push('Choose a valid ' + field.label.toLowerCase() + ' demo value.');
  ...
  function assess(options) {
    ...
    if (!isFinite(areaHa) || areaHa <= 0) errors.push('A positive park area is required for the demo balance.');
    ...
    components.water = component(
      'water', waterSign,
      waterLabel,
      (water.availability === 'unmeasured' ? 'No access observation was entered.' : 'Entered water access: ' + water.availability + '.') + ' The ' + season.short + ' and ' + selected.rainAmount.label.toLowerCase() + ' set the 30-day recharge or drawdown outlook.',
    ...
    var influences = [
      ...
      influence('woody', 'forage', selected.woodyCover.id === 'dense' ? -1 : selected.woodyCover.id === 'open' ? 1 : 0, 'Dense canopy competes with grass; open cover supplies the shelter-side demo branch.'),
