// lib/observations-renderer.js
// One configuration-driven renderer for every observations table: each page
// supplies its own columns, pagination style and row actions.
// The renderer only emits markup; the page wires the behaviour.
