// lib/date.js
// Stored UTC, displayed local: read through local getters, never slice the ISO
// string or pass a bare "YYYY-MM-DD" to new Date() (parses as UTC midnight).
...
(function (global) {
     ...
     * `<input type="time">` values. Local components go to the Date constructor,
     * so the resolved instant is the correct UTC moment for the viewer's zone;
     * appending 'Z' to the typed wall-clock would store the local reading as UTC.
     */
