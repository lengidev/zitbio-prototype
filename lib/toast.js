// lib/toast.js
// The app's shared toast surface. It replaced three half-implementations:
// showToast existed only on the field-officer page, the CSS lived in
// settings.css, and admin pages called it behind a `typeof === 'function'`
// guard so those calls silently did nothing. `window.showToast` is still
// provided for the call sites that already used that name.
...
(function () {
  ...
  /** Created on first use; no markup required. */
