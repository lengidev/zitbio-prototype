...
(function (root, factory) {
   ...
   */
  function managementRecommendations(changedKeys, driver, effects, pathways, area) {
    var recommendations = [];
    var seen = {};
  ...
  function evaluateScenario(input) {
    ...
    var recommendations = managementRecommendations(changedKeys, driver, edges, pathways, area);
