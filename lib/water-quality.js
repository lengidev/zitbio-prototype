...
(function (root, factory) {
  ...
  var SAMPLES = [
    ...
    { id: 'demo-reference', label: 'Demo · screened water available', provenance: 'demonstration', values: { ph: 7.2, oxygen: 7, turbidity: 4, referenceTurbidity: 4, availability: 'adequate', contamination: 'notObserved', bloom: 'notObserved' }, note: 'Explicit teaching values; not a field sample or proof of safe drinking water.' },
    { id: 'demo-oxygen', label: 'Demo · low oxygen and cloudy water', provenance: 'demonstration', values: { ph: 7.2, oxygen: 2, turbidity: 40, referenceTurbidity: 4, availability: 'adequate', contamination: 'notObserved', bloom: 'notObserved' }, note: 'Explicit teaching values. Low oxygen affects aquatic organisms; it does not establish toxicity to mammals.' },
    { id: 'demo-contamination', label: 'Demo · suspected contamination', provenance: 'demonstration', values: { ph: 5.5, oxygen: 4, turbidity: 30, referenceTurbidity: 4, availability: 'adequate', contamination: 'suspected', bloom: 'notObserved' }, note: 'Explicit contamination scenario. The contamination flag is an entered assumption, not inferred from pH alone.' },
