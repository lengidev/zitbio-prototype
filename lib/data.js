...
window.BioData = (function() {
  ...
  var defaultObservations = [
    ...
    // Counts per species sum to the research-documented park population
    ...
    },
    {
      ...
      source: 'field_observation',
      species_details: { scientific_name: 'Aepyceros melampus', common_name: 'Impala' },
      location: { latitude: -12.815, longitude: 28.213, country: 'Zambia', administrative_area: 'Copperbelt Province', city: 'Kitwe', focus_area: 'The CBU Nature Park', habitat_type: 'Miombo Woodland', locality_description: 'Herd browsing on fallen leaves and woody pods near the woodland edge' },
    ...
    // --- Emmanuel Chate (5 observations) ---
    {
      ...
      source: 'field_observation',
      species_details: { scientific_name: 'Equus quagga', common_name: 'Plains Zebra' },
      location: { latitude: -12.812, longitude: 28.214, country: 'Zambia', administrative_area: 'Copperbelt Province', city: 'Kitwe', focus_area: 'The CBU Nature Park', habitat_type: 'Miombo Woodland', locality_description: 'Zebra cropping tall fibrous grass near the Park perimeter, early morning' },
    ...
    },
    {
      ...
      source: 'field_observation',
      species_details: { scientific_name: 'Kobus ellipsiprymnus', common_name: 'Waterbuck' },
      location: { latitude: -12.817, longitude: 28.211, country: 'Zambia', administrative_area: 'Copperbelt Province', city: 'Kitwe', focus_area: 'The CBU Nature Park', habitat_type: 'Miombo Woodland', locality_description: 'Pair feeding on taller riverine grasses along the stream margin' },
    ...
    },
    {
      ...
      source: 'field_observation',
      species_details: { scientific_name: 'Kobus vardonii', common_name: 'Puku' },
      location: { latitude: -12.813, longitude: 28.215, country: 'Zambia', administrative_area: 'Copperbelt Province', city: 'Kitwe', focus_area: 'The CBU Nature Park', habitat_type: 'Miombo Woodland', locality_description: 'Small herd at the water margin, grazing tender grasses late afternoon' },
    ...
    },
    {
      ...
      source: 'field_observation',
      species_details: { scientific_name: 'Aepyceros melampus', common_name: 'Impala' },
      location: { latitude: -12.818, longitude: 28.212, country: 'Zambia', administrative_area: 'Copperbelt Province', city: 'Kitwe', focus_area: 'The CBU Nature Park', habitat_type: 'Miombo Woodland', locality_description: 'Mixed feeders on fresh grass and woody browse near the miombo tree line' },
    ...
    },
    {
      ...
      source: 'field_observation',
      species_details: { scientific_name: 'Aepyceros melampus', common_name: 'Impala' },
      location: { latitude: -12.814, longitude: 28.217, country: 'Zambia', administrative_area: 'Copperbelt Province', city: 'Kitwe', focus_area: 'The CBU Nature Park', habitat_type: 'Miombo Woodland', locality_description: 'Impala transitioning to dry-season browse in the northern woodland patch' },
