// lib/theme-init.js
// Puts data-theme on <html> before the first paint. Loaded as a BLOCKING script
// in <head>, before the stylesheets: applying it on DOMContentLoaded landed at
// ~1300ms, so a dark-mode session painted the light tokens first and the user
// saw white, then dark, then content.
// Deliberately NOT defer: deferring puts it back in the queue that caused it.
